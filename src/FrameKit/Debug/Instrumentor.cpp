// =============================================================================
// Project      : FrameKit
// File         : src/FrameKit/Debug/Instrumentor.h
// Author       : George Gil
// Created      : 2025-08-12
// Updated      : 2025-09-06
// License      : Dual Licensed: GPLv3 or Proprietary (c) 2025 George Gil
// Description  :
//      Instrumentation system for profiling C++ code.
// =============================================================================

#include "FrameKit/Debug/Instrumentor.h"
#include "FrameKit/Debug/Log.h"              // used only for error logs; safe privately
...
void Instrumentor::BeginSession(const std::string& name,
    ...
    if (m_CurrentSession) {
        if (Log::GetCoreLogger())
            FK_CORE_ERROR("Instrumentor::BeginSession('{0}') when session '{1}' already open.",
    ...
    if (m_OutputStream.is_open()) {
        ...
        if (Log::GetCoreLogger())
            FK_CORE_ERROR("Instrumentor could not open results file '{0}'.", filepath.string());
    }
}
...
void InstrumentationTimer::Stop() noexcept {
    ...
    const auto start_f64 = FloatingPointMicroseconds{ start_us };
